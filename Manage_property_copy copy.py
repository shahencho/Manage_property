...
async def handle_issue_media(update: Update, context: CallbackContext):
    ...
    # Store user's decision state to indicate they are currently in the media upload process
